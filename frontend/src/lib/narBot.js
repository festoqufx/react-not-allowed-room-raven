...
const replies = [
  {
    ...
    reply: (_text, name) => (
      `Here is the short tour, ${name}: create or join a room, type to chat, and tap the camera icon when you want video. Mention @nar in a room and I will answer there too.`
    ),
  },
  {
  ...
  },
  {
    ...
    reply: () => 'Anytime. I will be in the corner if you need another hand.',
  },
  {
...
export const narWelcomeMessage = (userName = 'there') => (
  `Hi ${String(userName || 'there').split(' ')[0]}. I am NAR. Ask me here, mention @nar in the room, or tap the chat bubble.`
);
